...
class CalendarVisualSettings {
    var SelectedBackgroundColor = UIColor.fromHex(0xE3C79B)//UIColor.fromHex(0x009DE0)
    var SelectedBackgroundColorAlpha: CGFloat = 1.0
    
    var SelectedTodayBackgroundColor = UIColor.fromHex(0xE3C79B)//UIColor.fromHex(0x009DE0)
    ...
    var SelectedTextBackgroundColor = UIColor.blackColor()//UIColor.whiteColor()
    ...
    var CurrentDayUnselectedCircleFillColor = UIColor(red: 0.894, green: 0.429, blue: 0.442, alpha: 1.0)
    var SelectedDayDotMarkerColor = UIColor.blackColor()//UIColor.whiteColor()
}